...
class StableDiffusionXLAdapterInpaintingPipeline(
    DiffusionPipeline,
    TextualInversionLoaderMixin,
    StableDiffusionXLLoraLoaderMixin,
    IPAdapterMixin,
    ...
    def enable_model_cpu_offload(self, gpu_id=0):
        ...
        cpu_offload_with_hook(self.adapter, device)
    ...
    def __call__(
            ...
            ori_image: Union[torch.FloatTensor, PIL.Image.Image] = None,
        ...
        timesteps, num_inference_steps = get_timesteps(
            self.scheduler, num_inference_steps, strength, device, denoising_start=denoising_start if denoising_value_valid else None
        )
        ...
        mask, masked_image, init_image = prepare_mask_and_masked_image(
            ori_image, mask_image, height, width, return_image=True
        )
